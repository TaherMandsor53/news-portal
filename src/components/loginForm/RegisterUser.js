        ...
        <Modal open={registerModalOpen} closeIcon onClose={this.Reset}>
            ...
            <Grid.Column style={{ maxWidth: 450 }}>
              ...
              <Form size="large" className="login-form">
                <Segment stacked className="login-box">
                  ...
                  <Button color="teal" size="large" className="register-button" onClick={this.validateUserDetails}>
                    Register
                  </Button>
                  <Button color="teal" size="large" className="register-button" onClick={this.onCancelClick}>
                    Cancel
                  </Button>
                </Segment>
              </Form>
          ...
          <Modal open={registeredModalOpen} size="small">
            ...
            <Modal.Content className="register-modal-content ">
              <p>You may now log-in with the registered email.</p>
